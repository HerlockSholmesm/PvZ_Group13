...
public class Shop {
    ...
    private void importZombie() {
        ...
        zombie = new MovingZombie("Football All.Zombie", 3, 4, 0);
        zombies.add(zombie);
        collectionZombies.add(zombie);
        zombie = new MovingZombie("Buckethead All.Zombie", 2, 3, 0);
        zombies.add(zombie);
        zombie = new MovingZombie("Conehead All.Zombie", 2, 3, 0);
        zombies.add(zombie);
        collectionZombies.add(zombie);
        zombie = new MovingZombie("Zomboni", 2, 3, 0);
        zombies.add(zombie);
        zombie = new MovingZombie("Catapult All.Zombie", 2, 3, 0);
        zombies.add(zombie);
        zombie = new MovingZombie("Bungee All.Zombie", 0, 3, 0);
        zombies.add(zombie);
        collectionZombies.add(zombie);
        zombie = new MovingZombie("Balloon All.Zombie", 2, 2, 0);
        zombies.add(zombie);
        collectionZombies.add(zombie);
        zombie = new MovingZombie("Newspaper All.Zombie", 2, 3, 2);
        zombies.add(zombie);
        zombie = new MovingZombie("Target All.Zombie", 2, 3, 3);
        zombies.add(zombie);
        zombie = new MovingZombie("Screen Door All.Zombie", 2, 2, 4);
        zombies.add(zombie);
        collectionZombies.add(zombie);
        zombie = new MovingZombie("Giga gargantuar", 1, 6, 0);
        zombies.add(zombie);
        zombie = new FlyingZombie("Pogo All.Zombie", 2, 2, 0);
        zombies.add(zombie);
        zombie = new SwimmingZombie("Snorkel All.Zombie", 2, 2, 0);
        zombies.add(zombie);
        zombie = new SwimmingZombie("Dolphin Rider All.Zombie", 2, 2, 0);
        zombies.add(zombie);
